...
const Service = () => {
  return (
    <div>
      ...
      <div className="col-md-3 mt-4"><Card sx={{ maxWidth: 345 }}>
      <CardMedia
        sx={{ height: 140 }}
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus corrupti aliquid perferendis blanditiis cupiditate repudiandae fugiat labore vero atque officia.
        </Typography>
      </CardContent>
      <CardActions>
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Totam vitae alias enim quia dolore iure voluptate. Quidem, nesciunt. Sit, magni!
        </Typography>
      </CardContent>
      <CardActions>
        <Button size="small">Share</Button>
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti culpa odio tempore repudiandae, doloribus magni omnis ut reiciendis nam illo.
        </Typography>
      </CardContent>
      <CardActions>
        <Button size="small">Share</Button>
